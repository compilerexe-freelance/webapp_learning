		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-offset-4 col-md-4" style="margin-top: 15px;">
				<div class="form-group text-center">
					<span style="font-size: 30px;">แก้ไข ติดต่อเรา</span>
				</div>
			</div>

			<div class="col-xs-12 col-sm-12 col-md-offset-1 col-md-10 col-md-offset-1" style="margin-top: 15px;">
				<div class="form-group">
					<?php echo form_open('c_admin/save_contact'); ?>
					<textarea name="txt_contact" class="form-control" rows="50" style="font-size: 18px; resize: none;">
						<?php $this->model_user->fetch_contact(); ?>
					</textarea>
				</div>
			</div>
