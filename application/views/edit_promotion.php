		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-offset-4 col-md-4" style="margin-top: 15px;">
				<div class="form-group text-center">
					<span style="font-size: 30px;">แก้ไข โปรโมชั่น</span>
				</div>
			</div>

			<div class="col-xs-12 col-sm-12 col-md-12" style="margin-top: 15px;">
				<div class="form-group">
					<?php echo form_open('c_admin/save_promotion'); ?>
					<textarea name="txt_promotion" class="form-control" rows="50" style="font-size: 18px; resize: none;">
